...
namespace DesktopToolShortcutRemapper
{
	public class DesktopToolShortcutRemapper : NeosMod
	{
		...
		public override string Link => "https://github.com/zkxs/runtime-frooxengine-mods/DesktopToolShortcutRemapper";
		...
		public override void OnEngineInit()
		{
			...
			Harmony harmony = new Harmony("net.michaelripley.DesktopToolShortcutRemapper");
			harmony.PatchAll();
		}
