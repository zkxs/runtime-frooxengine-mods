// This file is part of PlatformSpoof and is licensed under the GNU GPL v3.0.
...
namespace PlatformSpoof
{
	public class PlatformSpoof : NeosMod
	{
		internal const string VERSION = "1.1.1";
		public override string Name => "PlatformSpoof";
		...
		public override void OnEngineInit()
		{
			...
			Harmony harmony = new Harmony("net.michaelripley.PlatformSpoof");
